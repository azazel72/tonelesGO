...
def obtener_acciones() -> Dict[str, any]:
    return {
        ...
        "listar_stocks_consumo": lambda ws, req: Colector.colector.listar_stocks_consumo(),
        ...
        "agregar_trazabilidad_fabricacion_desde_stock": lambda ws, req: Colector.colector.agregar_trazabilidad_fabricacion_desde_stock(req.data),
