...
PERMISOS_POR_ACCION = {
    ...
    "listar_pedidos": {"planificacion", "fabricacion"},
    "listar_analiticas": {"fabricacion", "expedicion"},
    "obtener_analitica": {"fabricacion", "expedicion"},
    "guardar_analitica": {"fabricacion", "expedicion"},
